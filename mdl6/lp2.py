...
background_image = Image.open('latihan\Screenshot 2023-10-03 132250.png')
overlay_image = Image.open('latihan\Screenshot 2023-10-03 132925.png')
...
save_path = 'latihan/percobaan_tiga.png'
